  ...
  return (
    <>
      ...
      >
        ...
        >
          <span className="mt-20 w-3 rounded-full bg-[#30d0c0]/70" />
          <span className="mb-28 mt-10 w-3 rounded-full bg-primary/60" />
        </motion.div>

        {/* Scroll cue */}
        <div aria-hidden className="absolute bottom-6 left-1/2 z-10 hidden -translate-x-1/2 text-white/80 md:block">
          <motion.div
        ...
        <div className="mx-auto max-w-6xl px-5 text-center">
          ...
          <Reveal delay={0.06}>
            <h1 className="mx-auto mt-5 max-w-4xl font-display text-5xl font-medium leading-[1.04] tracking-tight text-ink sm:text-6xl md:text-7xl">
              ...
              <GradientText
                className="italic"
                gradient="linear-gradient(90deg, #e0a226 0%, #c9871a 30%, #e0a226 50%, #c9871a 70%, #e0a226 100%)"
              >
                {lastWord}.
              </GradientText>
            </h1>
