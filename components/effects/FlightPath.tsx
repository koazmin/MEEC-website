...
export default function FlightPath({ className = "" }: { className?: string }) {
  ...
  const route = "M -50 800 Q 300 200, 700 500 T 1100 100";
      ...
      {isInView && (
        <svg className="absolute inset-0 h-[120%] w-[120%] -left-[10%] -top-[10%] opacity-80" viewBox="0 0 1000 1000" preserveAspectRatio="none">
          ...
          <g fill="var(--color-primary)">
            ...
            {/* Inlining path directly prevents React <mpath> referencing bugs! */}
            <animateMotion dur="15s" repeatCount="indefinite" rotate="auto" path={route} />
          </g>
        </svg>
      )}
    </div>
